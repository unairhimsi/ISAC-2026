...
<img src="<?php echo e($logoUrl); ?>" alt="ISAC 2026" width="160" style="display:block;border:0;max-width:160px;height:auto;">
...
<h1 style="margin:10px 0 0;color:#ffffff;font-size:26px;line-height:1.25;"><?php echo e($title); ?></h1>
</td></tr>
<tr><td style="padding:30px 32px;color:#e4e7f4;font-size:15px;line-height:1.65;">
<p style="margin:0 0 16px;">Halo, <strong><?php echo e($team['name'] ?? 'Team ISAC'); ?></strong>.</p>
<p style="margin:0 0 22px;"><?php echo nl2br(e($message)); ?></p>
...
<p style="margin:0;color:#ffffff;font-weight:700;"><?php echo e($competition['name'] ?? 'ISAC 2026'); ?></p>
<p style="margin:10px 0 6px;color:#aeb6cf;font-size:12px;">BATCH</p>
<p style="margin:0;color:#ffffff;font-weight:700;"><?php echo e($competition['batch'] ?? '—'); ?></p>
<p style="margin:10px 0 6px;color:#aeb6cf;font-size:12px;">TAHAP</p>
<p style="margin:0;color:#ffffff;font-weight:700;"><?php echo e(data_get($payload, 'statusAfter') ?? data_get($payload, 'currentStage') ?? '—'); ?></p>
</td></tr></table>
<p style="margin:26px 0 0;"><a href="<?php echo e($dashboardUrl); ?>" style="display:inline-block;border-radius:999px;background:#a7ff5a;color:#141a0c;padding:12px 20px;text-decoration:none;font-weight:700;">Buka Team Dashboard</a></p>
...
<?php /**PATH /var/www/html/resources/views/emails/competition-operation.blade.php ENDPATH**/ ?>