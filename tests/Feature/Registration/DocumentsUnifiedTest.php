...
test('bpc documents does not auto-submit waiting_verification', function () {
    ...
    Registration::create(['team_id' => $team->id, 'competition_id' => $c->id, 'batch_id' => $b->id, 'status' => RegistrationStatus::WAITING_PAYMENT, 'team_completed_at' => now(), 'members_completed_at' => now(), 'payment_required_at' => now()]);
